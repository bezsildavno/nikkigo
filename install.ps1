...
$router = Read-Host "Press Enter to use $gateway, or type another address"
...
$sshUser = Read-Host 'Press Enter to use root, or type another login'
...
$sshPort = Read-Host 'Press Enter to use 22, or type another port'
