...
> [отказом от ответственности](DISCLAIMER.md) и принимаете ответственность
> за изменения на роутере.
...
Откройте обычную веб-панель роутера, заново войдите в LuCI после перезапуска
`rpcd`, перейдите `Сервисы → Nikki` и нажмите «Открыть панель».
